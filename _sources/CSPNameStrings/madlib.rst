...
**Qué hacer a continuación:** Ejecuta este programa para comprobar qué texto genera, y modifica el contenido de las variables para construir diferentes historias. Prueba con otros nombres, o con verbos distintos. 
...
.. Note::
   Cuando en Python se imprime una cadena (una secuencia de caracteres encerrados entre comillas simples o dobles) se imprimirán exactamente sus caracteres, tal como se han especificado entre las comillas. Cuando se imprime una variable, lo que se imprimirá será el valor de dicha variable.
